...
--cuda='cuda:0' --num_workers=2 --epochs=300 --batch_size=256 --test_interval=1 --optimizer='Adam'
...
--cuda='cuda:1' --num_workers=2 --epochs=300 --batch_size=256 --test_interval=1 --optimizer='Adam'

python3.6 main.py --model='MT' --dataset='Digits' --source='SVHN' --target='MNIST' \
--cuda='cuda:2' --num_workers=2 --epochs=300 --batch_size=256 --test_interval=1 --optimizer='Adam'
